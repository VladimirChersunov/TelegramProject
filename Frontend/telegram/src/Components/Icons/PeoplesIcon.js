export function PeoplesIcon(){
    return(
        <svg className="h-5 w-5 stroke-skin-stroke-base  dark:stroke-[#C6BDFF] fill-none" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
        <path
