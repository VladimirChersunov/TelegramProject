...
export function RadioChatList(props) {
 ...
 //console.log(props?.chats)
  ...
  return (
    ...
    className="flex max-h-screen w-full flex-col items-center  overflow-hidden sm:w-screen">
      <div onScroll={handleCloseContext} className="w-full h-screen overflow-auto overflow-y-scroll scrollbar" x-data="app">
