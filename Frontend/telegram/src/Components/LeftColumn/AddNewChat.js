  ...
  return (
      ...
      >
        ...
        <input type="file" onChange={handleChange} />
            <img className="h-[100px] w-[100px] ml-[30%] mt-5 rounded-full" src={file} />
        </div>
        <input className="m-5 text-xl border border-slate-400 px-2 rounded-md" placeholder="Group name/Channel Name"/>
        <input  className="m-5 text-xl border border-slate-400 px-2 rounded-md" placeholder="Description (optional)"/>
        <label className="text-xs opacity-70">You can provide an optional description for your channel</label>
