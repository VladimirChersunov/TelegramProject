export function RightMenu(props) {
  return (
    <ul
      className={`absolute mt-4  ml-[-180px] block  group-hover:block shadow-2xl  border border-slate-400 rounded-lg text-lg  w-[200px] `}
    >
      ...
      <li
        onClick={() => {}}
        className="hover:bg-indigo-900 hover:cursor-pointer text-red-600"
      >
        <div className=" p-1 flex flex-row">
          &#128465;
