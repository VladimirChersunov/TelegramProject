...
export function ColorRAdioButton(props) {
  ...
  return (
    <div className="flex justify-center mt-10" onChange={onChangeValue}>
      <div className="form-check form-check-inline" >
        ...
        />
        <label
          className="form-check-label inline-block text-red-600 mr-5"
      ...
      <div className="form-check form-check-inline">
        ...
        />
        <label
          className="form-check-label inline-block text-green-600 mr-5"
      ...
      <div className="form-check form-check-inline">
        ...
        />
        <label
          className="form-check-label inline-block text-blue-600 opacity-50 mr-5"
      ...
      <div className="form-check form-check-inline">
        ...
        />
        <label
          className="form-check-label inline-block text-black opacity-50"
          htmlFor="inlineRadio30"
        >
        Reset
        </label>
